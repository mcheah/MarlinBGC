from binGcode2.binGcode import *
import copy
import sys
import os
def encodeGcodeFile(filename="coffee_hanger2D.gcode",filename_out="coffee_hanger2D.bgc",bs=100*1024) :
